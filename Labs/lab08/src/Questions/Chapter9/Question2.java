...
public class Question2 
{
    ...
    */
    ...
    {
        int[][] downs = new int[111][11];
        double[][] averageSnow = new double[100][7];
        int[][][] favoriteCream = new int[3][52][17];
        String[][] names = new String[3][365];
        double[][][][][] store = new double[10][52][7][10][12];
        
        return new Object[] {downs, averageSnow, favoriteCream, names, store};        
    }
