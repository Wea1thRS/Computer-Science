...
public class Question3Test {
    ...
    {
        assertEquals("The cost of the first project is $74,000.00 which is 49% of the budget.", (String)results[4]);
    }
    
    @Test
    public void testQuestion4_Part6_IsCorrect()
    {
        assertEquals("The cost of the second project is 83 000,00 € which is 55 % of the budget.", (String)results[5]);
    }
