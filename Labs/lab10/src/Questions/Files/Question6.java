    ...
    public static ArrayList<Student> parseStudentFile(String fileName) {
        ...
        try {
            ...
            while(scan.hasNext()) {
                ...
                String gpa = scan2.next();
                ArrayList<String> courses = new ArrayList<>();
                while(scan2.hasNext()) {
                    courses.add(scan2.next());
                }
                String[] courses2 = courses.toArray(new String[courses.size()]);
                System.out.println("Name: " + name);
                System.out.println("Id: " + id);
                System.out.println("GPA: " + gpa);
                System.out.println("Courses: " + courses2);
                Student student = new Student(name, Integer.parseInt(id), Double.parseDouble(gpa), courses2);
