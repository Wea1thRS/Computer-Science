...
public class Question5Test {
    ...
    public void Question5_Part8_CorrectValue()
    {
        if(correctNumberOfVariables())
        {
            ...
            assertEquals("This test fails if the value for the variable declared for part 8) is incorrect", expected, (double)variableValues[7], 0.0);
        }
        else
        {
            hasVariable("result6");
            double expected = Integer.parseInt(variableValueMap.get("number1")) / Integer.parseInt(variableValueMap.get("number2"));
            assertEquals("This test fails if the value for the variable declared for part 8) is incorrect", expected, Double.parseDouble(variableValueMap.get("result6")), 0.0);
    ...
    public void Question5_Part9_CorrectValue()
    {
        if(correctNumberOfVariables())
        {
            ...
            assertEquals("This test fails if the value for the variable declared for part 9) is incorrect", expected, (double)variableValues[8], 0.0);
        }
        else
        {
            hasVariable("result7");
            ...
            assertEquals("This test fails if the value for the variable declared for part 9) is incorrect", expected, Double.parseDouble(variableValueMap.get("result7")), 0.0);
        }
    }
