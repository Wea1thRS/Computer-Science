...
public class Question3 
{
    ...
    public static void question3(Employee testEmployee)
    {
        ...
        if(testEmployee.getName().equals(defaultEmployee.getName())&& testEmployee.getID() == (defaultEmployee.getID()))
            System.out.println("The testEmployee is the same as the default employee.");
        else if((testEmployee.getName().equals(keanuEmployee.getName())) && (testEmployee.getID() == keanuEmployee.getID()))
        ...
        if(testEmployee == keanuEmployee)
            System.out.println("The test employee and keanuEmployee object references refer to the same memory location. Woah!");
        else
