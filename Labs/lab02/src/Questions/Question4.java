...
public class Question4 
{
    ...
    public static Student method()
    {
        ...
        System.out.println("What were your first three exam scores?(separated by space)");
        int firstExamScore = scanner.nextInt(), secondExamScore = scanner.nextInt(), thirdExamScore = scanner.nextInt();
        Student myStudent = new Student(studentName, studentId, firstExamScore, secondExamScore, thirdExamScore);
