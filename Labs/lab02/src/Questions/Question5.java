...
public class Question5 
{
    public static String method()
    {
        ...
        int firstExamScore = student1.getFirstExamScore();
        int secondExamScore = student1.getSecondExamScore();
        int thirdExamScore = student1.getThirdExamScore();
        double examScoreAverage = ((double) firstExamScore + secondExamScore + thirdExamScore)/3;
        String pattern = "0000000";
        DecimalFormat formattedId = new DecimalFormat(pattern);
        String pattern2 = "0.##";
        DecimalFormat formattedScore = new DecimalFormat(pattern2);
        String formattedOutput = "Name: " + student1.getName() + " ID: " + formattedId.format(student1.getID()) + " Average Score: " + formattedScore.format(examScoreAverage); 
